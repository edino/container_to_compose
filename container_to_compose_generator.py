# Container to Compose Generator: A Python3 script for generating Docker Compose files based on active containers in a Docker Production Environment
# Copyright © 2024 Edino De Souza
# Author: Edino De Souza
# Contact: edino@example.com
# Repository: https://github.com/edino/container_to_compose_generator
# License: GNU General Public License v3.0 - https://github.com/edino/container_to_compose_generator/blob/main/LICENSE
# This file is part of Container to Compose Generator.
# Version: 1.0.0
...
# 1. Install Python 3, Docker Python library, and PyYAML library using:
#    pip install docker pyyaml
# 2. Download the script using:
#    curl -sLo /tmp/container_to_compose_generator.py https://raw.githubusercontent.com/edino/container_to_compose_generator/main/container_to_compose_generator.py
# 3. Run the script using:
#    sudo python3 /tmp/container_to_compose_generator.py
# or
#    curl -s https://raw.githubusercontent.com/edino/container_to_compose_generator/main/container_to_compose_generator.py | python3 -

# Tested on: Ubuntu 20.04, Python 3.8.5, Docker 20.10.8
...
def generate_stack_docker_compose(containers_info, user_network_info, container_execution_path):
    ...
    for container_info in containers_info:
        ...
        stack_docker_compose_template['services'][service_name] = {
            ...
            'networks': {
                'my_network': {
                    'ipv4_address': f"{user_network_info['network_address']}/{user_network_info['ip_address_cidr'].split('/')[1]}"
                }
            },
...
def main():
    ...
    try:
        ...
        # Ask the user for the Container Execution Path
